...
export const UNIT_KEYS = Object.keys({ ...ENGLISH_UNIT, ...DUTCH_UNIT, ...GERMAN_UNIT, ...PORTUGUESE_UNIT});
export const TEN_KEYS = Object.keys({ ...ENGLISH_TEN, ...DUTCH_TEN, ...GERMAN_TEN, ...PORTUGUESE_TEN});
...
//@ts-ignore
export const NUMBER_WORDS = [...UNIT_KEYS, ...TEN_KEYS, ...MAGNITUDE_KEYS, ...HUNDRED_KEYS];

export const JOINERS = ['and', 'en', 'und','e'];
